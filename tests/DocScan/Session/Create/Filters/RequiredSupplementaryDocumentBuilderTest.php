...
class RequiredSupplementaryDocumentBuilderTest extends TestCase
{
     ...
     * @covers ::withDocumentTypes
     */
    public function withDocumentTypesShouldThrowWithEmptyArray()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('documentTypes cannot be empty');
     ...
     * @covers ::withCountryCodes
     */
    public function withCountryCodesShouldThrowWithEmptyArray()
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->expectExceptionMessage('countryCodes cannot be empty');
